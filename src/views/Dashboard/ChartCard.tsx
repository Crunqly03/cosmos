  ...
  return (
        ...
        <ChartHeaderTop>
            <Flex alignItems="center">
                ...
                <Tooltip>
                <IconContainer style={{border:"50%",width:"14px",height:"14px",marginLeft:"12px"}}>
                    <img src={`${window.location.origin}/images/infoCoolBg.svg`} alt="" />
                </IconContainer>
                <Tooltiptext>
                {desc}
                </Tooltiptext>

...
import { stake, sousStake, sousStakeBnb, stakeDelegateFarm ,stakeLPDelegateFarm,vaultStake} from 'utils/callHelpers'
import { useMasterchef, useSousChef, useDelegateFarmContract,useLpDelegateFarmContract ,useCakeVaultContract} from './useContract'
